module github.com/acharyasreej/vm-operator-api/hack/samples
...
replace github.com/acharyasreej/vm-operator-api => ../../../vm-operator-api

require (
	github.com/acharyasreej/vm-operator-api v0.0.0
